  ...
  return new Promise(function(resolve, reject) {
    ...
    var initQuestions = [
      ...
      },
      {
        type: 'input',
        name: 'cryptoKey',
        message: 'Secret key to cypher clients passwords (watch your ideman settings or use default)',
        default: nconf.get(env + ':crypto:key') || 'o!rDE(Qbrq7u4OV'
      },
      {
        type: 'input',
        name: 'cryptoInputEnc',
        message: 'Input encoding of clients passwords',
        default: nconf.get(env + ':crypto:inputEncoding') || 'utf8'
      },
      {
        type: 'input',
        name: 'cryptoOutputEnc',
        message: 'Output encoding of clients passwords',
